...
ADMIN_ID = 123456789  # 👈 آیدی عددی تلگرام خود را اینجا قرار دهید
...
4️⃣ مدت زمان آزمون را تعیین کنید (0 برای نامحدود)
5️⃣ به سوالات پاسخ دهید
6️⃣ پاسخ‌های صحیح را وارد کنید
7️⃣ نتیجه خود را مشاهده کنید
